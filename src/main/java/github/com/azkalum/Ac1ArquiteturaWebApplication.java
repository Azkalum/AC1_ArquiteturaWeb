...
public class Ac1ArquiteturaWebApplication {
    ...
    public CommandLineRunner init(@Autowired ProdutoRepository produtoRepository, @Autowired CategoriaRepository categoriaProdutoRepository) {
        ...
        return args -> {
            ...
            System.out.println("Categorias que começam com 'Joi': ");
            List<Categoria> categoriasQueComecamCom = categoriaProdutoRepository.findByCatNomeStartingWith("Joi");
    ...
    public static void main(String[] args) {
        SpringApplication.run(Ac1ArquiteturaWebApplication.class, args);
    }
